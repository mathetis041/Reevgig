        ...
        >
                    ...
                    <div className={stylesTwo.labelStyle}>
                        ...
                        <div className={stylesTwo.filetextCont}>
                            ...
                            <div className={stylesTwo.filetext2}>
                                Supported formats: PDF. Max 3 files.
                            </div>
                        </div>
                    </div>
                </label>
            ...
            {files.length > 0 && (
                <div className={styles.fileUploadedCont}>
                    <div className={styles.ThumbHeaderText}>Uploaded Files</div>
                    <div className={styles.ThumbSubText}></div>
                    <div className={styles.fileUploadedThumbnailContpdf}>
                        {files.map((file) => (
                            <div key={file.id} className={styles.fileItem}>
                                <div className={styles.pdfDiv}>
                                    <img src="https://res.cloudinary.com/do5wu6ikf/image/upload/v1731883901/Reev/17th%20Nov/uil_file-alt_ubrbew.svg" alt="FILEiCON"/>
                                    <div>
                                        <p className={styles.fileName}>{truncateFileName(file.name, 10)}</p>
                                    </div>
                                    <img
